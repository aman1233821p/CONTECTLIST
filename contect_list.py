contect_list=[]
contect_list.append(["aman","6203267388","aman@gmail.com","mango"])
contect_list.append(["sohan","9608062282","sneha@gmail.com","sakchi"])
...
def add():
    ...
    opinion=input("for more add say yes and for not say no :")
    if(opinion=="yes"):
        add()
    else:
        return
...
def remove():
    ...
    opinion=input("for more remove say yes and no say no :")
    if(opinion=="yes"):
        remove()
    else:
        return
...
def search():
    ...
    while(j<=len(contect_list)-1):
        ...
        while(k<=3):
            ...
            k+=1
        j+=1
    opinion=input("for more search say yes and no say no :")
    if(opinion=="yes"):
        search()
    else:
        return
...
def update():
    ...
    opinion=input("for more update say yes and no say no :")
    if(opinion=="yes"):
        update()
    else:
        return
